...
# create agent
obs_dim, act_dim, act_limit = env.get_observation().shape[0], env.action_dim, env.action_spec[1][0]
agent = core.MLPActorCritic(obs_dim, act_dim, act_limit)
...
def main():
    ...
    for t in range(horizon):
        ...
        # Simulation
        action = get_action(obs, 0) # sample agent action
